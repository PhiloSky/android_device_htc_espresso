...
#PRODUCT_VERSION_DEVICE_RELEASE := ALPHA1
#PRODUCT_VERSION_DEVICE_SPECIFIC := -Bluewater-$(PRODUCT_VERSION_DEVICE_RELEASE)
CM_RELEASE := true
CM_BUILDTYPE := UNOFFICIAL
#CM_EXTRAVERSION := Bluewater-$(PRODUCT_VERSION_DEVICE_RELEASE)